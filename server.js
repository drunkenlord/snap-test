...
let argv = yargs
			...
			.describe('metadata_dir','Metadata directory')
			.alias('metadata_dir','m')
			.alias('logdir','l')
			...
			.default({
				...
				//'metadata_dir' : '"/home/parallels/hapi_metadata",'
			})
			.argv
...
const META_DIR    = argv.metadata_dir;
